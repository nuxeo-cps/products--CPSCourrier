...
IN_MAILS_PER_MAILBOX = 5
OUT_MAILS_PER_MAILBOX = 5
...
USERNAMES = (
    u"Adolphe Thiers",
    u"Patrice de Mac-Mahon",
    u"Jules Grévy",
    u"Sadi Carnot",
    u"Jean Casimir-Perier",
    u"Félix Faure",
    u"Émile Loubet",
    u"Armand Fallières",
    u"Raymond Poincaré",
    u"Paul Deschanel",
    u"Alexandre Millerand",
    u"Gaston Doumergue",
    u"Paul Doumer",
    u"Albert Lebrun",
)
...
при разгрузке т/х Polydefkis 24 марта в 22 часа 40 минут в четвертом трюме была обнаружена подмочка сахара- сырца. Выгрузка сырца из этого трюма приостановлена. Невыгруженный тоннаж в  четвертом трюме составляет 1642 тонны. Нами к расследованию причин подмочки груза привлечена компания "МАРИНЕКС  Ай Эл Си Эс", которая указана в страховом сертификате.
Этьен поставлен в известность о подмочке и считаем, так как на судне половина груза принадлежит другой компании, то количество подмоченного груза должно быть распределено между грузовладельцами поровну. Ждем ваших комментариев.
